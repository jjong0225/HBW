# Generated by Django 2.1.2 on 2019-03-19 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_time', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('대여가능', '대여가능'), ('대여중', '대여중'), ('대여불가', '대여불가'), ('대여신청중', '대여신청중')], default='대여가능', max_length=5)),
                ('borrowed_by', models.OneToOneField(blank=True, error_messages={'unique': '한 사람 당 한 개씩만 대여 가능합니다.'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='un', to='login.Student')),
            ],
        ),
        migrations.AddField(
            model_name='lan',
